...
#
# Generated by export_simulation on Tue May 05 21:21:41 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './dist_mem.sh' script.

./dist_mem.sh -reset_run
...
./dist_mem.sh -noclean_files

For more information on the script, please type './dist_mem.sh -help'.
