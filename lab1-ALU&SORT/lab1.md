...
<img src="D:\Markdown\lab1.assets\校徽.jpg" alt="校徽" style="zoom:50%;" align="center" />
...
<img src="D:\Markdown\lab1.assets\image-20200429013900251.png" alt="image-20200429013900251" style="zoom:50%;"  />
...
<img src="D:\Markdown\lab1.assets\image-20200429015106630.png" alt="image-20200429015106630" style="zoom:50%;" />
...
- **RTL ANALYSIS-Schematic：**
  ...
  ![RTL](D:\Markdown\lab1.assets\image-20200429162744541.png)

- **Vivado仿真如下：**

  - **ADD测试：**

    <img src="D:\Markdown\lab1.assets\image-20200429090345006.png" alt="ADD simulation" style="zoom: 80%;" />
  ...
  - **SUB测试：**
    ...
    <img src="D:\Markdown\lab1.assets\image-20200429091716640.png" alt="SUB-simulation" style="zoom:80%;" />
  ...
  - **AND测试：**
    ...
    <img src="D:\Markdown\lab1.assets\image-20200429092213426.png" alt="SUB-simulation" style="zoom:80%;" />
  ...
  - **OR测试：**
    ...
    <img src="D:\Markdown\lab1.assets\image-20200429092433429.png" alt="OR-simulation" style="zoom:80%;" />
  ...
  - **XOR测试：**
    ...
    <img src="D:\Markdown\lab1.assets\image-20200429112701880.png" alt="image-20200429112701880" style="zoom:80%;" />
...
- 利用前面设计的ALU模块，辅之以若干寄存器和数据选择器，以及适当的控制器，设计实现四个4位有符号数的排序电路，其逻辑符号如下图所示所示：
  ...
  <img src="D:\Markdown\lab1.assets\image-20200429115207291.png" alt="" style="zoom:40%;" />

- **四个符号数排序电路的数据通路如下图所示**：

  <img src="D:\Markdown\lab1.assets\image-20200429150353894.png" alt="image-20200429150353894" style="zoom:30%;" />

- **排序电路状态控制图如下**：

  <img src="D:\Markdown\lab1.assets\image-20200429153204970.png" alt="state graph" style="zoom:30%;" />
...
- **RTL ANALYSIS-Schematic：**
  ...
  ![SORT-RTL](D:\Markdown\lab1.assets\image-20200429163008380.png)

- Vivado仿真如下：**

  - **无符号数排序测试：**

    <img src="D:\Markdown\lab1.assets\image-20200429154151207.png" alt="unsigned testcase" style="zoom:80%;" />

  - **有符号数排序测试（带负数）：**

    <img src="D:\Markdown\lab1.assets\image-20200429155758888.png" alt="signed test" style="zoom:80%;" />
...
2. **如果为了提高性能，使用两个ALU，电路如何调整？**
   ...
   <img src="D:\Markdown\lab1.assets\image-20200429162222176.png" alt="adjusted graph" style="zoom:30%;" />
